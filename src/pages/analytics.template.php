        ...
        <div class="about-area ptb-100">
            <div class="container">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                      Data e hora do servidor: <?= date('d/m/Y H:i:s'); ?> <br/>
                      Total de anúncios: <?= $itemCount; ?>
                  </div>
                </div>

                <div class="row align-items-center marginTopChat">
                ...
                <div class="table-responsive mt-4">
                  <table class="table table-bordered">
                      ...
                      <?php 
                        ...
                        $jsonData = file_get_contents('../cached/views.json');
                        ...
                        foreach ($data as $item) {
                                $uuid = $item['uuid'];
                                $title = isAds($item['uuid'],'title');
                                $updatedAt = $item['updatedAt'];
                                $views = $item['views'];

                                if($uuid) {
                                  $link = $CONFIG['CONF']['siteUrl']."/imovel/".$uuid.".html";
                                }
                        ?>
                          <tr>
                              <td>
